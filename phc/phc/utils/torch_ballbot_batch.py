...
class Ballbot_Batch:
    def __init__(self, mjcf_file = f"resources/robots/ballbot/ballbot.xml", extend_hand = True, extend_head = False, device = torch.device("cpu")):
        ...
        print("Ballbot model names:", self.model_names)
        print("Length of model names:", len(self.model_names))
        print("Ballbot joint names:", self.joint_names)
